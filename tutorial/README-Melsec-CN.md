...
| SB1F  | 链接特殊继电器     | SB  | 0x1F  | BIT  | **16进制** | ✅    |
| SW1F  | 链接特殊寄存器     | SW  | 0x1F  | WORD | **16进制** | ✅    |
| DX2F  | 直接访问输入      | DX  | 0x2F  | BIT  | **16进制** | ❌    |
| DY12F | 直接访问输出      | DY  | 0x12F | BIT  | **16进制** | ❌    |
| ZR1C  | 文件寄存器连号访问方式 | ZR  | 0x1C  | WORD | **16进制** | ❌    |
...
R系列PLC。
- ZR使用十六进制作为地址。例如：mcPlc.writeInt16 ("ZR100", 4852) -> 该值将被写入到地址"ZR256"（256是十进制）
